...
class Wa_Click_To_Chat {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Whatsapp_Widget_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Whatsapp_Widget_Loader. Orchestrates the hooks of the plugin.
	 * - Whatsapp_Widget_i18n. Defines internationalization functionality.
	 * - Whatsapp_Widget_Admin. Defines all hooks for the admin area.
	 * - Whatsapp_Widget_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Whatsapp_Widget_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
