...
function getWhatsappLink(widgetConfig) {
  return "https://wa.me/" + validatePhoneLink(widgetConfig.phone) + (widgetConfig.text != "" ? "/?text=" + validateTextLink(widgetConfig.text) : "");
}

function renderWidget(widgetConfig) {
  var widgetElement = document.createElement("div");
  var whatsappLink = getWhatsappLink(widgetConfig);
  var htmlString = widgetConfig.type == "ww-extended" ? getExtendedHtmlString(whatsappLink, widgetConfig) : getStandardHtmlString(whatsappLink, widgetConfig.call);
...
function tmWidgetInit(widgetConfig) {
  var widgetElement = renderWidget(widgetConfig);
  ...
  <div id="ww-chat" class="ww-chat">
    <div class="ww-chat__wrapper" >
      ...
      <div class="ww-chat__button-container">
        <a target="_blank" class="ww-chat__button" role="button" href="${whatsappLink}" title="WhatsApp" rel="noreferrer noopener">
