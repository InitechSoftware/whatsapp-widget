...
function renderWidget(widgetConfig) {
  ...
  let whatsappLink = getWhatsappLink(widgetConfig);
  let htmlString = widgetConfig.type == "ww-extended" ? getExtendedHtmlString(whatsappLink, widgetConfig) : getStandardHtmlString(whatsappLink, widgetConfig.call);
