...
class Free_Click_To_Chat_Button_By_TimelinesAI_Public {
  ...
  public function insert_widget(){
    ...
    <a target="_blank" href="'.esc_url($whatsapp_link).'" class="ww-text">' . esc_attr($widget_meta_options['en']['call_to_action']) . '</a>
    <div class="ww-icon">
    <div>
      <a target="_blank" href="'. esc_url($whatsapp_link).'">
      ...
      <div><a class="ww-link" type="link" href="https://timelines.ai">TimelinesAI</a></div>
    </div>
  </div>';
  }
