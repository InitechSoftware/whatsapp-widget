...
class Free_Click_To_Chat_Button_By_TimelinesAI_Public {
  ...
  public function insert_widget(){
    ...
    echo '<div id="whatsapp-widget" class="ww-' . esc_attr($widget_meta_options['en']['position']) . ' ww-' . esc_attr($widget_meta_options['en']['size']) . ' ww-'.esc_attr($widget_meta_options['en']['widget_display']).'">
    <a target="_blank" href="'.esc_url($whatsapp_link).'" class="ww-text">' . esc_attr($widget_meta_options['en']['call_to_action']) . '<div class="ww-arrow"></div></a>
    <div class="ww-icon">
    <div>
      <a class="ww-icon-link" target="_blank" href="'. esc_url($whatsapp_link).'">
