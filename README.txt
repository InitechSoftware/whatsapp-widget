...
2. Enter the Call to Action that will be displayed on the widget (e.g. Message Us)
3. Optimally, enter the pre-filled message. It helps your customer to start a conversation with you with a request template (e.g. вЂњHi! IвЂ™m interested in learning more about your serviceвЂќ)
4. Choose size and position if needed.
5. Press Save Settings to publish the widget
